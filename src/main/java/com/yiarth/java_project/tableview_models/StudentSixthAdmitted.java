...
public class StudentSixthAdmitted {
    /**
     * This class is a model of the TableView for students who were admitted to Sixth class.
     * <p>
    ...
    public StudentSixthAdmitted(String numEleve, String nom, String prenom, String ecole, double moyenne) {
