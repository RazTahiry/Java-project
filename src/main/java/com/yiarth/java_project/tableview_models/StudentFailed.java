...
public class StudentFailed {
    /**
     * This class is a model of the TableView for students who were failed to their CEPE.
     * <p>
    ...
    public StudentFailed(String numEleve, String nom, String prenom, String ecole, double moyenne) {
